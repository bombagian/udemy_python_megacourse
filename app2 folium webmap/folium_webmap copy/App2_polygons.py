...
fg=folium.FeatureGroup(name='MyMap') #create feature group - you can put things in it and handle them as a single layer. 

fg.add_child(folium.GeoJson(data=open('app2-webmapping/world.json','r',encoding='utf-8-sig'),
...
map.save("map4.html") #save it as html
